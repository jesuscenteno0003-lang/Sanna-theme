...
$queryContent = 'mutation { productCreate(product: {title: "Test REPISA Direct", vendor: "REPISA", productType: "Test", status: ACTIVE, productOptions: [{name: "Default Title", values: [{name: "Default"}]}]}) { product { id title status } userErrors { field message } } }'
